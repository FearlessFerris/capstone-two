...
//         const userId = req.user.id;
//         console.log( userId );
//         console.log( `I am being sent to the back!!!`, req.params );
//         const { bookmarkId } = req.params;
//         const parsedBookmark = parseInt( bookmarkId );
...
//         const result = await db.query( query, [ notes, parsedBookmark, userId ]);
